...
If time allows, you may want to try out a second simulation example, which models the air flow around a two-dimensional wing profile.  This is the required setup (a Slurm setup is also available in the alternate directory `slurm_pawsey`):
...
<img src="{{ page.root }}/fig/wing_p_pressure.png" alt="Wing pressure map" width="400" style="float:left;"/>

<img src="{{ page.root }}/fig/wing_nut_viscosity.png" alt="Wing viscosity map" width="400" style="float:left;"/>

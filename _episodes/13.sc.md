...
Note how with Singularity the user in the container is the same as in the host machine. Also note that the operating system information comes from the container and not from the host.
